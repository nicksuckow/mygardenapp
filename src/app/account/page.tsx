...
export default function AccountPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-cream-50 via-cream-100 to-cream-200 border border-cream-200 p-6">
        {/* Decorative settings icon */}
        <div className="absolute top-0 right-0 opacity-10">
          <svg className="w-32 h-32 text-earth-warm" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" />
          </svg>
        </div>

        <div className="relative flex items-center gap-3">
          <div className="flex-shrink-0 bg-gradient-to-br from-earth-warm to-earth-deep text-white p-2.5 rounded-xl shadow-md">
          ...
          <div>
            <h1 className="text-2xl font-bold bg-gradient-to-r from-earth-warm to-earth-deep bg-clip-text text-transparent">
              Account Settings
            </h1>
