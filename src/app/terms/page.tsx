    ...
    <div className="max-w-3xl mx-auto">
      <div className={`${ui.card} ${ui.cardPad} space-y-6`}>
        ...
        <div className="prose prose-slate prose-sm max-w-none">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">3. User Accounts</h2>
          <p className="text-slate-700">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">4. Acceptable Use</h2>
          <p className="text-slate-700">
            You agree not to:
          </p>
          <ul className="list-disc pl-5 text-slate-700 space-y-1">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">5. User Content</h2>
          <p className="text-slate-700">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">6. Third-Party Services</h2>
          <p className="text-slate-700">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">7. Disclaimer of Warranties</h2>
          <p className="text-slate-700">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">8. Limitation of Liability</h2>
          <p className="text-slate-700">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">9. Modifications to Service</h2>
          <p className="text-slate-700">
            We reserve the right to modify, suspend, or discontinue any part of the Service at
            any time. We will make reasonable efforts to notify users of significant changes.
          </p>

          <h2 className="text-lg font-semibold text-slate-900 mt-6">10. Account Termination</h2>
          <p className="text-slate-700">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">11. Changes to Terms</h2>
          <p className="text-slate-700">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6">12. Governing Law</h2>
          <p className="text-slate-700">
            These Terms shall be governed by and construed in accordance with applicable laws,
            without regard to conflict of law provisions.
          </p>

          <h2 className="text-lg font-semibold text-slate-900 mt-6">13. Contact</h2>
          <p className="text-slate-700">
