    ...
    <div className="max-w-3xl mx-auto">
      <div className={`${ui.card} ${ui.cardPad} space-y-6`}>
        ...
        <div className="prose prose-earth prose-sm max-w-none">
          ...
          <h2 className="text-lg font-semibold text-earth-deep mt-6">2. Information We Collect</h2>

          <h3 className="text-base font-medium text-earth-deep mt-4">Account Information</h3>
          <p className="text-earth-deep">
          ...
          <h3 className="text-base font-medium text-earth-deep mt-4">Garden Data</h3>
          <p className="text-earth-deep">
          ...
          <h3 className="text-base font-medium text-earth-deep mt-4">Automatically Collected Information</h3>
          <p className="text-earth-deep">
          ...
          <h2 className="text-lg font-semibold text-earth-deep mt-6">3. How We Use Your Information</h2>
          <p className="text-earth-deep">
          ...
          <h2 className="text-lg font-semibold text-earth-deep mt-6">4. Data Sharing</h2>
          <p className="text-earth-deep">
          ...
          <h2 className="text-lg font-semibold text-earth-deep mt-6">5. Data Security</h2>
          <p className="text-earth-deep">
          ...
          <h2 className="text-lg font-semibold text-earth-deep mt-6">6. Your Rights</h2>
          <p className="text-earth-deep">
          ...
          <h2 className="text-lg font-semibold text-earth-deep mt-6">7. Data Retention</h2>
          <p className="text-earth-deep">
            We retain your data for as long as your account is active. When you delete your account,
            all associated data is permanently removed from our systems.
          </p>

          <h2 className="text-lg font-semibold text-earth-deep mt-6">8. Children's Privacy</h2>
          <p className="text-earth-deep">
            Our service is not intended for users under the age of 13. We do not knowingly
            collect information from children under 13.
          </p>

          <h2 className="text-lg font-semibold text-earth-deep mt-6">9. Changes to This Policy</h2>
          <p className="text-earth-deep">
            We may update this Privacy Policy from time to time. We will notify you of any
            changes by posting the new policy on this page and updating the "Last updated" date.
          </p>

          <h2 className="text-lg font-semibold text-earth-deep mt-6">10. Contact Us</h2>
          <p className="text-earth-deep">
